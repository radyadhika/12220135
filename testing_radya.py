...
############### first column ###############
col1.subheader("Tabel representasi data")
col1.dataframe(df_csv_clean.head(n_tampil))
############### first column ###############

############### second column ###############
col2.subheader("Jenis transportasi")
...
############### third column ###############
col3.subheader("Total penumpang perbulan")
...
############### fourth column ###############
B2 = col4.number_input("Banyak Negara", min_value=1, max_value=None, value=10)
