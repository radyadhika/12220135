...
print(df_tahun_clean.iloc[0]['KodeNegara'])
col5b.markdown(df_tahun_clean.iloc[0]['KodeNegara'])
...
print(df_tahun_clean.iloc[len(df_tahun_clean)-1]['KodeNegara'])
col5b.markdown(df_tahun_clean.iloc[len(df_tahun_clean)-1]['KodeNegara'])
...
col5b.markdown(df_tahun_clean.iloc[len(df_tahun_clean)-1]['Sub-region'])
